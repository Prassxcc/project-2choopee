                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title">Kawaski H2R</h5>
                                    ...
                                    <div class="card-body">
                                        <button class="btn btn-primary"
                                            wire:click="simpan('Kawaski H2R','1000000000')">BELi</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3">
                            ...
                            <div class="col-3">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">Rp. 255.000.000</li>
                                    </ul>
                                    <div class="card-body">
                                        <button class="btn btn-primary"
                                            wire:click="simpan('cbr250rr','255000000')">BELi</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="card" style="width: 18rem;">
                                    <img src="../gambar/ducati.jpeg" class="card-img-top" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title">ducati panigale v4</h5>
                                        <p class="card-text">motor idaman para pria</p>
                                    </div>
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">Rp. 600.000.000</li>
                                    </ul>
                                    <div class="card-body">
                                        <button class="btn btn-primary"
                                            wire:click="simpan('ducati panigale v4','600000000')">BELi</button>
                                    </div>
                                </div>
                            </div>
                        </div>
